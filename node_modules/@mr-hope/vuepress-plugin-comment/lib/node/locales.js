...
exports.walineLocales = exports.valineLocales = exports.pageInfoLocales = void 0;
/**
 * Default lcoales config for Page Info
 */
exports.pageInfoLocales = {
    "/en/": {
        author: "Author🖊",
        date: "Writing Date📅",
        origin: "Original💡",
...
exports.valineLocales = {
    ...
    "/de/": {
        placeholder: "Schreibe ein Kommentar (Geben Sie die E-Mail-Adresse ein, um eine E-Mail-Benachrichtigung zu erhalten, wenn Sie geantwortet werden)",
    },
    "/vi/": {
    ...
    "/ru/": {
        placeholder: "Напишите здесь комментарий (введите адрес электронной почты, чтобы получать уведомление по электронной почте при ответе)",
    },
    "/br/": {
