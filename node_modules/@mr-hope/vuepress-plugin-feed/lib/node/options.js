...
const getFeedChannelOption = (options, context) => {
    ...
    const defaultChannelOpion = Object.assign(Object.assign(Object.assign({ title, link: (0, utils_1.resolveUrl)(hostname, base), description, language: (0, vuepress_shared_1.getRootLang)(context), copyright, pubDate: new Date(), lastUpdated: new Date() }, (icon ? { icon } : {})), (image ? { image } : {})), (author ? { author: { name: author } } : {}));
